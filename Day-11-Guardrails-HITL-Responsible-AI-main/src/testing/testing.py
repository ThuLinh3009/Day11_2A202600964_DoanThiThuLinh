...
#
# So sánh kết quả trước và sau khi có guardrail.
# Protected agent dùng InputGuardrailPlugin + OutputGuardrailPlugin.
# ============================================================
...
async def run_comparison():
    ...
    # --- Protected agent với guardrail plugins ---
    print("\n" + "=" * 60)
    print("PHASE 2: Protected Agent (với Guardrails)")
    print("=" * 60)
    input_plugin = InputGuardrailPlugin()
    # use_llm_judge=False để tránh gọi API thêm trong test nhanh
...
# TODO 11: Automated Security Testing Pipeline
#
# Framework tái sử dụng để test bất kỳ agent nào.
# Tự động phân loại: blocked / leaked / error.
# Tính metrics và in report có cấu trúc.
# ============================================================
